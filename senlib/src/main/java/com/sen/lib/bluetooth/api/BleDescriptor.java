...
public class BleDescriptor extends BleAttribute implements Parcelable {
    ...
    public static final Creator<BleDescriptor> CREATOR = new Creator() {
    ...
    public byte setValue(byte[] value, int offset, int length, BleGattID gattUuid, int totalSize, String address) {
        ...
        if(uuid == 10500) {
            ...
            Log.i("BleDescriptor", "##offset=" + offset + " mMaxLength=" + this.mMaxLength + " length=" + length);
