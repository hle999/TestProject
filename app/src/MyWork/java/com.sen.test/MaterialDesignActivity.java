...
import com.sen.test.util.PagerSlidingTabStrip;
import com.sen.test.util.SuperAwesomeCardFragment;

/**
 * Editor: sgc
 * Date: 2015/01/26
 */
public class MaterialDesignActivity extends ActionBarActivity implements LoaderManager.LoaderCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                toolbar, R.string.text_drawer_open, R.string.text_drawer_close);
...
//                colorChange(arg0);
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = { "分类", "主页", "热门推荐", "热门收藏", "本月热榜", "今日热榜", "专栏", "随机",
                                        "分类", "主页", "热门推荐", "热门收藏", "本月热榜", "今日热榜", "专栏", "随机",
                                        "分类", "主页", "热门推荐", "热门收藏", "本月热榜", "今日热榜", "专栏", "随机"};
