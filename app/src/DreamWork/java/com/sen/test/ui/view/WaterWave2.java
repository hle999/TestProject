 ...
 */
public class WaterWave2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        if (!firstLoad) {
            bgImage = BitmapFactory.decodeResource(this.getResources(), R.drawable.ic_launcher);
